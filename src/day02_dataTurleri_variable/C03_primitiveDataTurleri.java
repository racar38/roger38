...
public class C03_primitiveDataTurleri {
    ...
    public static void main(String[] args) {
        ...
        // 1-boolen:mantiksel degerler olan true ve false kabul eder
        boolean bl1= true;
        boolean bl2= false;

        // char '' içinde yazilir ve sadece 1 karakter kabul eder.
        char ch1 = 'a';
        char ch2 = '2';
        char ch3 = '/';
        char ch4 = ' ';
        ...
        // data tutu ayni olan variable'larin degerleri ne olursa olsun
        ...
        // double bolme islemlerinde 0,00000000001 gibi bir hata yapabilir
        // 20 / 5 = 3,9999999999999

        String str= "Hello World";

        System.out.println(str); // Hello World
        System.out.println("true veya false "); // true veya false
