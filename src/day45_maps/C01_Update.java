...
public class C01_Update {
    ...
    public static void main(String[] args) {
        ...
        //{101=Ali-Can-11-H-MF,
        // 102=Veli-Cem-10-K-TM,
        // 103=Ali-Cem-11-T-TM,  T OLMUŞ
        // 104=Ayse-Can-10-H-MF,
        // 105=Sevgi-Han-11-M-TM, HAN OLMUŞ
        // 106=Sevgi-Can-10-K-MF}

        /*
        Map'de bir value'yu update etmek istersek
        1-bilgiye ulasmak icin yaptiğimiz gibi adim adim value'yu array 'e cevirmeliyiz
           - key ile value'yu cagiririz
           - value'yu array'e ceviririz
           -array'de istediğimiz update'i yapariz
        2- bilgiye ulasmak icin parçaladıgımız value'yu yeni haliyle birlestiririz
