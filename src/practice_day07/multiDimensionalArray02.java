...
public class multiDimensionalArray02 {
    ...
    public static void main(String[] args) {
        ...
        boolean kontrol = false; // sehir dogru ise yani buldugunda true ile durdurmasi icin...
        ...
        if (!kontrol) {   // true ya dönmedigi zaman yani farkli bir sehir girildiginde kontrol etmek icin
